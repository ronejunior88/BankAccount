...
namespace Domain.Dto.v1
{
    public class TransferBankAccountAllDto
    {
        ...
        public TransferBankAccountAllDto(int idTransfer, int idClient, int idPerson, int idAccount, string typeAccount, string nameBank, string typeTransfer, decimal valueTranfer, DateTime date)
        {
            Transfer = idTransfer;
            Client_Id = idClient;
            Person_Id = idPerson;
