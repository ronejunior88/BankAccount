...
namespace Domain.Dto.v1
{
    public class TransferBankAccountIdClientDto
    {
        ...
        public TransferBankAccountIdClientDto(int idClient, int idPerson, int idAccount, decimal balance, string typeAccount, string nameBank, string typeTransfer, string valueTranfer)
        {
            IdAccount = idClient;
            IdPerson = idPerson;
            IdAccount = idAccount;
